...
enum class FieldSlot : uint8_t {
    ...
    SERIAL_0_ROLE,
    SERIAL_0_BAUD,
    SERIAL_0_ACTIVE_ROLE,
    SERIAL_0_STATUS,
    SERIAL_0_REBOOT_REQUIRED,
    SERIAL_1_ROLE,
    SERIAL_1_BAUD,
    SERIAL_1_ACTIVE_ROLE,
    SERIAL_1_STATUS,
    SERIAL_1_REBOOT_REQUIRED,
    SERIAL_2_ROLE,
    SERIAL_2_BAUD,
    SERIAL_2_ACTIVE_ROLE,
    SERIAL_2_STATUS,
    SERIAL_2_REBOOT_REQUIRED,
    SERIAL_3_ROLE,
    SERIAL_3_BAUD,
    SERIAL_3_ACTIVE_ROLE,
    SERIAL_3_STATUS,
    SERIAL_3_REBOOT_REQUIRED,
    SERIAL_4_ROLE,
    SERIAL_4_BAUD,
    SERIAL_4_ACTIVE_ROLE,
    SERIAL_4_STATUS,
    SERIAL_4_REBOOT_REQUIRED,
    SERIAL_5_ROLE,
    SERIAL_5_BAUD,
    SERIAL_5_ACTIVE_ROLE,
    SERIAL_5_STATUS,
    SERIAL_5_REBOOT_REQUIRED,
    SERIAL_6_ROLE,
    SERIAL_6_BAUD,
    SERIAL_6_ACTIVE_ROLE,
    SERIAL_6_STATUS,
    SERIAL_6_REBOOT_REQUIRED,
    SERIAL_7_ROLE,
    SERIAL_7_BAUD,
    SERIAL_7_ACTIVE_ROLE,
    SERIAL_7_STATUS,
    SERIAL_7_REBOOT_REQUIRED,
    SERIAL_8_ROLE,
    SERIAL_8_BAUD,
    SERIAL_8_ACTIVE_ROLE,
    SERIAL_8_STATUS,
    SERIAL_8_REBOOT_REQUIRED,
    SERIAL_9_ROLE,
    SERIAL_9_BAUD,
    SERIAL_9_ACTIVE_ROLE,
    SERIAL_9_STATUS,
    SERIAL_9_REBOOT_REQUIRED,
    RCIN_TIMEOUT_MS,
    RCIN_PROTOCOLS,
    VSP_X,
    VSP_Y,
