...
{
    uint16_t count = capability_has(*_capability, CAP_NATIVE_USB) ? 1 : 0;
    if (_capability->pwm_outputs != 0) {
        count += 1; // PWM bank
