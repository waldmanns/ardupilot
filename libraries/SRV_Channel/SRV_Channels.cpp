...
const AP_Param::GroupInfo SRV_Channels::var_info[] = {
    ...
    // @Description: Bitmask of RCIN1Scaled to RCIN16Scaled passthrough input channels which will be set to the output trim value during RC failsafe instead of holding their last valid input value. This does not affect RCPassThru(1) or raw RCIN1 to RCIN16 passthrough outputs.
    // @Bitmask: 0:RCIN1Scaled, 1:RCIN2Scaled, 2:RCIN3Scaled, 3:RCIN4Scaled, 4:RCIN5Scaled, 5:RCIN6Scaled, 6:RCIN7Scaled, 7:RCIN8Scaled, 8:RCIN9Scaled, 9:RCIN10Scaled, 10:RCIN11Scaled, 11:RCIN12Scaled, 12:RCIN13Scaled, 13:RCIN14Scaled, 14:RCIN15Scaled, 15:RCIN16Scaled
    // @User: Advanced
